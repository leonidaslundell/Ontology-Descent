...
* Validate that the ground truth data look sufficiently diverse.
* Analyze ground truth data using both simplify enrichment and our method.
...
Generate 50 different samples and test various summary statistics of it.
...
The following code is trying to figure out which metrics are good for one cluster, preferably in one simple quantifiable number in order to get be able to objectivly compare the performace of various clustering and distance algos.
